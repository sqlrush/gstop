...
func logicalDatasetDDL(schema string) []string {
	...
	return append(ddl,
		...
		index("plan_data_lookup_idx", "plan_data", "lookup_key, dist_key, id"),
		index("plan_stats_target_idx", "plan_data", "stats_target_key, dist_key, id"),
		index("plan_stats_ndistinct_idx", "plan_data", "stats_ndistinct_key, dist_key, id"),
		index("plan_stats_corr_idx", "plan_data", "stats_corr_a, stats_corr_b, dist_key, id"),
		index("plan_index_unusable_idx", "plan_data", "index_unusable_key, dist_key, id"),
		index("plan_index_drop_idx", "plan_data", "index_drop_key, dist_key, id"),
		index("plan_index_shape_good_idx", "plan_data", "index_shape_lead, index_shape_tail, dist_key, id"),
